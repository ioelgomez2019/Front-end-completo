...
public class Analizador {
    ...
    public Analizador(AnalizadorLexico al) throws IOException { lex = al; mover(); }
    /*public Analizador(AnalizadorLexico  al) throws IOException { 
        lex = al;//delaramos un puntero para mi anañizador lexico
        mover();
    }*/
